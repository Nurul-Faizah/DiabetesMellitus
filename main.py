...
with tabs[1]:
    with st.expander("Role"):
        (st.write("""
            ...
            2. Glucose          : Plasma glucose concentration a 2 hours in an oral glucose tolerance test (mempresentasikan konsentrasi glukosa plasma pada 2 jam dalam tes toleransi glukosa dengan satuan mg/dL miligram per desiliter).
            3. Blood Pressure   : Diastolic blood pressure (Tekanan darah adalah cara yang sangat terkenal untuk mengukur kesehatan jantung seseorang, ada juga ukuran tekanan darah yaitu diastolik dan sistolik. Dalam data ini, kita memiliki tekanan darah diastolik dalam (mm / Hg) milimeter hydrargyrum ketika jantung rileks setelah kontraksi).
            ...
            9. Outcome          : Class variable (0 or 1), 0 untuk tidak mengidap diabetes, dan 1 mengidap diabetes.
        """))
